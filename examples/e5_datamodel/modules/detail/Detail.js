Aria.classDefinition({
    $classpath : "examples.e5_datamodel.modules.detail.Detail",
    $extends : "examples.e5_datamodel.modules.base.BaseModuleController",
    $implements : ["examples.e5_datamodel.modules.detail.DetailInterface"],
    $constructor : function () {
         ...
         * @type String
         */
        this._filter = "examples.e5_datamodel.modules.detail.mock.DetailFilter";
    ...
    $prototype : {
        ...
        $publicInterfaceName : "examples.e5_datamodel.modules.detail.DetailInterface",

Aria.classDefinition({
    ...
    $implements : ["examples.e5_datamodel.modules.search.SearchInterface"],
    $constructor : function () {
         ...
         * @type String
         */
        this._filter = "examples.e5_datamodel.modules.search.mock.SearchFilter";
    ...
    $prototype : {
        ...
        $publicInterfaceName : "examples.e5_datamodel.modules.search.SearchInterface",

Aria.classDefinition({
    ...
    $implements : ["examples.e6_pageprovider.modules.search.SearchInterface"],
    $constructor : function () {
         ...
         * @type String
         */
        this._filter = "examples.e6_pageprovider.modules.search.mock.SearchFilter";
    ...
    $prototype : {
        ...
        $publicInterfaceName : "examples.e6_pageprovider.modules.search.SearchInterface",
